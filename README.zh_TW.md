...
<div align="center">
<h1 id="localization-of-the-vyper-documentation">Vyper 文件的在地化</h1>
</div>
...
The goal of this project is to translate The Vyper Documentation into multiple languages. 翻譯是在 Crowdin 平臺上進行貢獻，然後會自動與 GitHub 儲存庫進行同步，並且可以在 GitHub Pages 上進行預覽。
